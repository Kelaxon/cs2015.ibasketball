...
这个项目是本小组在软件工程专业课上的一周实习周完成的Web端。
开发IDE： Eclipse

框架：Struts2、Hibernate3、Bootstrap



架构图

<img src="README_Images/01.png" height="40%" width="40%" >
...
使用Eclipse导入Project。本项目不是由Maven构建，但是jar包都在lib文件夹底下。 :smile:
